# How can you use data binding in WinUI radial gauge with the MVVM pattern

This repository contains sample for using data binding in [Syncfusion WinUI radial gauge](https://help.syncfusion.com/winui/radial-gauge/getting-started) control with the MVVM pattern.
